...
$app->clientShortcuts
        ->add('lightbox', function(IvoPetkov\BearFrameworkAddons\ClientShortcut $shortcut) use ($context) {
            ...
            $shortcut->requirements[] = [
                'type' => 'text',
                'value' => '.ipjslghtbc{opacity:0;position:fixed;z-index:10010000;top:0;left:0;width:100%;height:100%;background-color:rgba(0,0,0,0.8);-webkit-transition:opacity 300ms;transition:opacity 300ms;}'
