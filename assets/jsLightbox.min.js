...
this.open=function(f){var b='<div id="'+g+'" class="'+("js-lightbox-conatiner "+a.options.containerClassName).trim()+'" style="position:fixed;z-index:10010000;top:0;left:0;width:100%;height:100%;'+a.options.containerStyle+'">',b=b+('<div class="swiper-container-'+g+'" style="width:100%;height:100%;">'),b=b+'<div class="swiper-wrapper">',c;for(c in a.images)var d=a.images[c],b=b+('<div class="swiper-slide" style="padding-top:'+a.options.paddingTop+";padding-right:"+a.options.paddingRight+";padding-bottom:"+
