...
if (typeof ivoPetkov.bearFrameworkAddons.jsLightbox === 'undefined') {
    ...
    ivoPetkov.bearFrameworkAddons.jsLightbox = (function () {
        ...
        var loadSwiper = function () {
            if (swiperStatus === 0) {
                ...
                if (ivoPetkov.bearFrameworkAddons.jsLightboxGlobalData.swiperCssUrl !== null) {
                    var link = document.createElement('link');
                    link.rel = 'stylesheet';
                    link.href = ivoPetkov.bearFrameworkAddons.jsLightboxGlobalData.swiperCssUrl;
        ...
        return function (data) {
            ...
            this.open = function (index) {
                var html = '<div id="' + containerID + '" class="' + ('js-lightbox-container ' + data.options.containerClassName).trim() + '" style="position:fixed;z-index:10010000;top:0;left:0;width:100%;height:100%;' + data.options.containerStyle + '">';
                ...
                for (var i in data.images) {
                    ...
                    container.firstChild.firstChild.childNodes[imagesCounter].firstChild.firstChild.innerHTML = image.html;
                    imagesCounter++;
                }
                ...
                if (swiperStatus === 3) {
                    ...
                    loadSwiper();
                    var checkAndExecute = function (b, c) {
                        if (b())
                            c();
                        else {
                            var a = function () {
                                b() ? (window.clearTimeout(a), c()) : window.setTimeout(a, 16)
                            };
